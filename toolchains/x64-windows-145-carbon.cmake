...
if (NOT _CCP_TOOLCHAIN_FILE_LOADED)
    ...
    set(CMAKE_INTERPROCEDURAL_OPTIMIZATION_TRINITYDEV OFF)
    list(APPEND CMAKE_CXX_LINK_FLAGS_TRINITYDEV "/LTCG:OFF")
    list(APPEND CMAKE_CXX_LINK_FLAGS_TRINITYDEV "/INCREMENTAL")
endif ()
